...
public class CurvesView_two extends View {
	...
	public CurvesView_two(Context context) {
		super(context);
	}

	public CurvesView_two(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	private void drawLeftLabels(Canvas canvas) {
		...
		for (int i = 0; i < left_levels.length; i++) {
			...
			labelY = centerY + labelHigh / 2;
			if (i > 0) {
				canvas.drawText(s, labelX - labelWidth - 10, labelY
						- fm.descent, labelPaint);
			}
		}
