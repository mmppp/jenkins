...
//		expandableListView.setOnGroupCollapseListener(new OnGroupCollapseListener() {//为ExpandableListview监听关闭分组事件
//
//					@Override
...
//				});
//
//		expandableListView.setOnGroupExpandListener(new OnGroupExpandListener() {//为ExpandableListview监听展开分组事件
//
//					@Override
...
//				});
//		// 设置二级item点击的监听器
//		expandableListView.setOnChildClickListener(new OnChildClickListener() {//为ExpandableListview监听子项单击事件
//
//			@Override
